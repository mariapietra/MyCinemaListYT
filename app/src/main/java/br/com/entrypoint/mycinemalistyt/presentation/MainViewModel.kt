...
class MainViewModel (
    ...
    val popularMovie: LiveData<List<PopularMovie>>
        get() = _popularMovies
        ...
        call.enqueue(
            object : Callback<PopularMovieResponse>{
                override fun onResponse(
                    p0: Call<PopularMovieResponse>,
                    p1: Response<PopularMovieResponse>
                ) {
                ...
                override fun onFailure(p0: Call<PopularMovieResponse>, p1: Throwable) {
